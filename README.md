...
> reliability fixes from v3.2 and later (except the HDMI EDID work, which is
...
> front-panel display. For the current v3.4 feature set, use the pre-built
...
include most v3.2-and-later fixes, since apart from the HDMI EDID work
